...
extension PHPhotoLibrary {
    ...
    func savePhoto(image:UIImage, albumName: String? = nil, completion:((PHAsset?)->())? = nil) {

        let albumName = albumName ?? Bundle.main.infoDictionary?[kCFBundleNameKey as String] as! String
